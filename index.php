...
<head>
    ...
    <title>India Law Platform - Dashboard</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">Here at the India Law Platform, we aim to enable researchers, academicians, lawyers, etc to study the causal impacts of legal rulings.</p>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Pending HC Cases</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">5675630</div>
                                        </div>
                                        <div class="col-auto">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">HC Judges' Vacancy
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                Pending in HC 1+ yrs</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">86.37%</div>
                                        </div>
                                        <div class="col-auto">
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-header py-3">
                                        <h6 class="m-0 font-weight-bold text-primary">Female Representation across various HCs</h6>
                                </div>
                                <div class="card-body">
                                    <div class="chart-bar">
                        ...
                        <div class="col-xl-4 col-lg-5">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">HC Case Pendency Pie-Chart</h6>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mt-4 text-center small">
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-primary"></i> 0-1 years
                                        </span>
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-success"></i> 1-5 years
                                        </span>
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-info"></i> 5-30 years
                                        </span>
